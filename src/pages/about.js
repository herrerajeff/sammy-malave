...
export default function About({ data: { allPosts, site, global } }) {
  const posts = allPosts.nodes

  return (
    <App>
        <HelmetDatoCms seo={global.seo} favicon={site.favicon} />
        <Header aboutPhoto={global.aboutPhoto.small}  ig={global.instagramUsername} tw={global.twitterUsername} email={global.emailAddress} openState={true} />
        <main>
